              ...
              {activeTab === 'streams' ? (
                ...
                <div className="video-upload-section">
                  ...
                  <div style={{ marginTop: '0.75rem' }}>
                    <label style={{ fontSize: '0.85rem', color: '#555' }}>Or paste a video URL (YouTube, Vimeo, etc.)</label>
                    <input
                      type="url"
                      value={selectedFile ? '' : formData.url}
                      onChange={(e) => { setSelectedFile(null); setFormData({...formData, url: e.target.value}); }}
